...
- Add ingo#regexp#deconstruct#{Translate,Remove}CharacterClasses() and
  ingo#regexp#deconstruct#TranslateNumberEscapes() and include both
  translations in ingo#regexp#deconstruct#ToQuasiLiteral().
