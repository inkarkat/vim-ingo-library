...
call vimtap#Is(ingo#option#listchars#Render("\t\t  some text\t", 1, {'tabWidth': 3}), '<-><->  some text<->$', 'tab text with shorter tab width 3')
call vimtap#Is(ingo#option#listchars#Render("\t\t  some text\t", 1, {'tabWidth': 2}), '<><>  some text<>$', 'tab text with tab width 2')
