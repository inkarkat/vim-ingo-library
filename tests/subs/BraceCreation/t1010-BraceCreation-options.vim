...
call vimtap#Is(s:Call('FooHasBoo FOOBoo FoOBox', {'short': 1}), 'Foo[Has]Bo[ox]', 'short = unique and square braces and ignore-case')
call vimtap#Is(s:Call('FooHasBoo FOOBoo FoOBox', {'isIgnoreCase': 0, 'short': 1}), 'F{ooHas,OO,oO}Bo[ox]', 'short without ignore-case')
call vimtap#Is(s:Call('FooHasBoo FOOBoo FoOBox', {'optionalElementInSquareBraces': 0, 'short': 1}), 'Foo{Has,}Bo[ox]', 'short without optionalElementInSquareBraces')
call vimtap#Is(s:Call('FooHasBoo FOOBoo FoOBox', {'singleCharacterElementsInSquareBraces': 0, 'short': 1}), 'Foo[Has]Bo{o,x}', 'short without singleCharacterElementsInSquareBraces')
call vimtap#Is(s:Call('FooHasBoo FOONoBoo FoONoBox', {'uniqueElements': 0, 'short': 1}), 'Foo{Has,No,No}Bo[oox]', 'short without uniqueElements')
